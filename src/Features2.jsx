...
let notifications = [
  {
    ...
    icon: <FiSearch className="text-cyan-300" />,
  },
  {
    ...
    icon: <FiShoppingCart className="text-violet-300" />,
  },
  {
    ...
    icon: <RiSignalWifiLine className="text-emerald-300" />,
  },
  {
    ...
    icon: <MdSupportAgent className="text-orange-300" />,
  },
  {
    name: "Invoice Generated",
    description: "Recurring billing processed",
    time: "15m ago",
    bg: "bg-pink-500/15 border-pink-400/30",
    iconBg: "bg-pink-400/20",
    icon: <FiCreditCard className="text-pink-300" />,
  },
  {
    ...
    icon: <FiRefreshCw className="text-blue-300" />,
  },
  {
    ...
    icon: <FiSettings className="text-yellow-300" />,
  },
  {
    name: "Secure Access Verified",
    description: "Two-factor authentication successful",
    time: "25m ago",
    bg: "bg-lime-500/15 border-lime-400/30",
    iconBg: "bg-lime-400/20",
    icon: <BsShieldCheck className="text-lime-300" />,
  },
];
